...
// Depura el siguiente código
  ...
  if (gameState===PLAY){
    ...
    {
      jungle.x+400
    //no logre hacer que el escenario se repitiera pero logre corregir los demas errores
    }
   console.log(kangaroo.y);
    ...
    kangaroo.velocityY = kangaroo.velocity.y + 0.8;
    spawnShrubs();
    spawnObstacles();
...
// Encuentra el error en el siguiente código
    var shrub = createSprite(camera.position.x+500,340,40,40);
